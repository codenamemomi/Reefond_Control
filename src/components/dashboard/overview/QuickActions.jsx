...
const QuickActions = () => {
    const actions = [
        { label: 'Create Filing', icon: Plus, color: 'bg-ree-green' },
        { label: 'Submit Refund', icon: FileBarChart, color: 'bg-blue-500' },
        { label: 'Compliance Report', icon: PieChart, color: 'bg-indigo-500' },
        { label: 'Upload Documents', icon: Upload, color: 'bg-amber-500' },
    ];
